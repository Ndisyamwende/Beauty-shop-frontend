...
=======
      const response = await axios.post(" https://beautyshop-backend-1.onrender.com/login", {
      ...
      <div className="max-w-lg w-full p-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-base">Don’t have an account yet?{' '}
            <Link to="/signup" className="font-bold text-[#a6603a]">Signup</Link>
          </p>
        </div>
        <div className="space-y-6">
          ...
          <button
            ...
            onClick={handleLogin}
          >
            <span className="font-extrabold text-white text-lg">Login</span>
          </button>
        </div>
