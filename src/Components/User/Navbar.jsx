...
const Navbar = () => {
  ...
  return (
    <div className={`py-4 ${darkTheme ? 'bg-gray-800' : 'bg-[#efe3b8]'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-between">
        ...
        <div className="relative flex-grow flex justify-center w-full lg:w-auto">
          <div className="relative w-full max-w-lg">
            <input
              className={`w-full h-[40px] ${darkTheme ? 'bg-gray-700 text-white border-white' : 'bg-[#efe3b8] text-black border-black'} rounded-[15px] border border-solid pl-10 pr-4 [font-family:'Inter-Regular',Helvetica] font-normal text-[12px]`}
        ...
        <div className="flex space-x-4 items-center mt-4 lg:mt-0">
          ...
          <Link to="/signin" className={darkTheme ? "text-white" : "text-black cursor-pointer text-2xl"}>
            <PiSignOutBold />
          </Link>
        </div>
      </div>
