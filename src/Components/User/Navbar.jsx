    ...
    <div className={`py-4 `}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-between">
        ...
        <div className="relative flex-grow flex justify-center w-full lg:w-auto">
          ...
          >
            <input
              className={`w-full h-[40px]  rounded-[15px] border border-solid pl-10 pr-4 [font-family:'Inter-Regular',Helvetica] font-normal text-[12px]`}
              placeholder="Search for beauty Brands and Products"
            />
            <FaSearch className={`absolute left-3 top-1/2 transform -translate-y-1/2  text-lg`} />
          </div>
          {!showSearch && (
            <FaSearch
